...
public class RainforestLeaveDecorator extends LeaveVineDecorator {
	...
	public static MapCodec<RainforestLeaveDecorator> CODEC = MapCodec.unit(RainforestLeaveDecorator::new);

	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("betterminecraft:rainforest_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public RainforestLeaveDecorator() {
		super(0.25f);
	}
