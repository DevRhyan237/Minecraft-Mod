...
public class CaptainPirateEntity extends Raider implements RangedAttackMob {

	public static final EnumProxy<Raid.RaiderType> RAIDER_TYPE = new EnumProxy<>(Raid.RaiderType.class, BetterminecraftModEntities.CAPTAIN_PIRATE, new int[]{0, 0, 0, 0, 2, 2, 3, 4});

	public CaptainPirateEntity(EntityType<CaptainPirateEntity> type, Level world) {
		super(type, world);
		xpReward = 15;
		setNoAi(false);
		...
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(BetterminecraftModItems.CANNON.get()));
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(6, new AvoidEntityGoal<>(this, Creaking.class, (float) 6, 1, 1.2));
		this.goalSelector.addGoal(7, new AvoidEntityGoal<>(this, DevourerEntity.class, (float) 6, 1, 1.2));
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("betterminecraft:pirate_captain_idle"));
	}
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("betterminecraft:pirate_captain_hurt"));
	}
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		CannonBallEntity.shoot(this, target);
	}
