...
public class CoconutEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(BetterminecraftModItems.THROWABLECOCONUT.get());
	...
	protected ItemStack getDefaultPickupItem() {
		return new ItemStack(BetterminecraftModItems.THROWABLECOCONUT.get());
	}
	...
	public static CoconutEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		CoconutEntity entityarrow = new CoconutEntity(BetterminecraftModEntities.COCONUT.get(), entity, world, null);
		...
		world.playSound(null, entity.getX(), entity.getY(), entity.getZ(), BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("entity.snowball.throw")), SoundSource.PLAYERS, 1, 1f / (random.nextFloat() * 0.5f + 1) + (power / 2));
		return entityarrow;
	}

	public static CoconutEntity shoot(LivingEntity entity, LivingEntity target) {
		CoconutEntity entityarrow = new CoconutEntity(BetterminecraftModEntities.COCONUT.get(), entity, entity.level(), null);
		...
		entity.level().playSound(null, entity.getX(), entity.getY(), entity.getZ(), BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("entity.snowball.throw")), SoundSource.PLAYERS, 1, 1f / (RandomSource.create().nextFloat() * 0.5f + 1));
		return entityarrow;
	}
}
